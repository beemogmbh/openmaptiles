...
Hints for naviki poi:
  make import-sql-dev                  # start import-sql /bin/bash terminal"
  make import-osm-dev                  # start import-osm /bin/bash terminal (imposm3)"
  make import-poi-priority             # import priority data for points of interest"
  make import-poi-all				   # import category and priority data for points of interest"
  make test-import-poi			       # run tests for import-poi-all"
...
import-poi-priority: start-db
	$(DOCKER_COMPOSE) run $(DC_OPTS) import-poi-priority
  
.PHONY: import-poi-all
import-poi-all: start-db
	$(DOCKER_COMPOSE) run $(DC_OPTS) import-poi-all
  
.PHONY: test-import-poi
test-import-poi: start-db
	$(DOCKER_COMPOSE) run $(DC_OPTS) test-import-poi
